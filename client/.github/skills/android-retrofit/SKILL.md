...
description: Expert guidance on setting up and using Retrofit for type-safe HTTP networking in Android. Covers service definitions, coroutines, OkHttp configuration, and Koin integration.
---
...
### 5. Koin & Serialization Configuration
